...
#                             conn_labels.append(1)
                            conn_labels.append(1 if spl[i][j] < 5 else 0)                              
#               
...
#                 print(torch.max(all_conns))
        ...
        relation_pred = self.net.relation_embed(relation_feature) #.module
        
        connection_feature = torch.cat(connection_feature, 0)
        connection_pred = self.net.connection_embed(connection_feature) #.module
